...
const PitchFlowStart = ({ flowData: { project }, onAccept }: any) => {
  useEffect(() => {
    (async () => {
      await deleteConversationLogByProjectId(project.id);
    })();
  }, []);
      ...
      <Stack alignItems="center">
        ...
        <Stack.Item>
          <Text textAlign="center" spacing="l">
            He will watch your pitch demo video and decide if he wants to invest in your project. You get a few chances
            to convince him and win the game, but beware: he is a tough cookie.
          </Text>
        </Stack.Item>
        <Stack.Item>
          <Formik
