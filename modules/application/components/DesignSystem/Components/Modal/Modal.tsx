...
const Modal = ({
  ...
  const modalPanelClassNames = classNames(
    'relative text-left bg-gray-50 rounded-lg shadow-xl transition-all sm:my-28 sm:w-full sm:max-w-lg ',
    {
  ...
  return (
    <Transition.Root show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative" onClose={onRequestClose} initialFocus={bodyRef}>
